...
const DateComponent = ({onDateSelect}) => {
    ...
    <Group position="center" spacing="xl">
      ...
      {weekDates
        ...
        <Center key={index} style={{ flexDirection: 'column', cursor: 'pointer' }} onClick={() => handleDateClick(date)}>
          <Badge
            color={date.isSame(selectedDate, 'day') ? 'blue' : 'gray'}
            size="lg"
            radius="xl"
      ...
      <Button onClick={handleNextDay} variant="subtle" disabled={selectedDate.isSame(maxEndDate.subtract(1, 'day'), 'day')}>
